...
class SendEmails extends Command
{
    ...
    public function handle()
    {
        ...
        $msg = '';
        $mark = 0;
        $subject = iconv("GBK", "UTF-8//IGNORE", "��ҽ��û�а��SendEmails");
        ...
        if ($info[0]['extraState'] != 'null') {
            ...
            $content = $msg;
            if ($mark > 0) {
                $subject = iconv("GBK", "UTF-8//IGNORE", "����Լ��ҽ����!");
                array_push($to, "332926195@qq.com");
            }
        } else {
            $subject = iconv("GBK", "UTF-8//IGNORE", "cookie������");
        }
     ...
     * @param string $post �������
     * @param string $cookie ����ʽ
     * @param int $returnCookie ��ʱʱ�䣨�룩
     * @return mixed
     */
